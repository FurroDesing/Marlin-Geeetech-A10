...
#define CUSTOM_USER_BUTTONS
  ...
  #define BUTTON2_PIN 67
    ...
    #define BUTTON2_DESC          "Preheat PLA " 
  #endif
  ...
  #define BUTTON3_PIN 34
    ...
    #define BUTTON3_DESC          "Preheat ABS"
  #endif
  ...
  #define BUTTON4_PIN 14
    ...
    #define BUTTON4_GCODE         "M18"
    #define BUTTON4_DESC          "Dissable steppers"
  #endif
  ...
  #define BUTTON5_PIN 15
    ...
    #define BUTTON5_GCODE         "M600"
    #define BUTTON5_DESC          "Change filament"
  #endif
#endif
